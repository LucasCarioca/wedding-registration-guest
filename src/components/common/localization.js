...
export const homeLocalization = new LocalizedStrings({
  ...
  es: {
    ...
    transportationTitle: 'Lake Como Private Transfers',
    accommodations: 'Si quieres hospedarte en el Hotel Villa Cipressi o Villa Vittoria, tenemos una tarifa de descuento para nuestros invitados. Puedes contactar al hotel directamente via email (info@hotelvillacipressi.it) e informarles que vas a asistir a la boda de Karen Ardila y Lucas de Souza del 12-14 de septiembre del 2023',
  ...
  br: {
    ...
    transportationTitle: 'Lake Como Private Transfers',
    accommodations: 'If you wish to stay at Hotel Villa Cipressi or Villa Vittoria, we have a discounted rate for our guests. You may contact the hotel directly by email (info@hotelvillacipressi.it) let you need to book a room to attend Karen Ardila and Lucas de Souza’s wedding from September 12-14th 2023',
    howToArrive: 'Once in the Milan airport, guests will take the Milano Centrale to Varenna- esino train station arriving directly in Varenna',
    travelAgent: 'If you wish to visit other places in Europe, our travel agent Luciane Garcia will be happy to help you with the plane tickets, planning your itinerary, and finding accommodations. Please note bookings can only be made as early as October 2022',
    transportation: 'Safe Airport Transfers to and from Lake Como - Milan Area',
  }
