...
export const homeLocalization = new LocalizedStrings({
  en: {
    ...
    accommodations: 'If you wish to stay at Hotel Villa Cipressi or Villa Vittoria, we have a discounted rate for our guests. You may contact the hotel directly by email (info@hotelvillacipressi.it) them know you need to book a room to attend Karen Ardila and Lucas de Souza’s wedding from September 12-14th 2023',
